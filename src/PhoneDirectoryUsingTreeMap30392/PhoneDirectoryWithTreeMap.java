package PhoneDirectoryUsingTreeMap30392;
...
/*
		...
		Lab Overview: In this lab, we will create a basic PhoneDirectory by using
		 a TreeMap to store directory entries.
		
		The program: 
		Finds the phone number, if any, for a given name and returns the phone number 
		associated with the name if the name does not occur in the phone directory, 
		...
		Create a new Java project and create a new Class named “PhoneDirectoryWithTreeMap,” 
		and then write the below code in the class.
